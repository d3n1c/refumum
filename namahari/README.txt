...
Pastikan konstanta "REFUMUM_DB_USE" dalam file namahari.module dan namahari.insall
...
Akses Administer -> Site building -> Modules dan aktifkan module Referensi Nama Hari.

Fitur Tersedia
----------------------

Module ini mengatur variabel nama hari yang lazim digunakan di hampir urusan administrasi
...
Anda bisa menggunakan fungsi default setting, yang akan mengisi nilai variabel nama hari
